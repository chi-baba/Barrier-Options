...
def up_out_put_barrier_mc(S0,K,T,r,q,sigma,B,R):
...
prc_mc = up_out_put_barrier_mc(S0,K,T,r,q,sigma,B,R)
print('\nThe Monte Carlo price of the up and out put option is:',round(prc_mc,4))
