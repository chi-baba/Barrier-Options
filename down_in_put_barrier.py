...
def down_in_put_barrier_mc(S0,K,T,r,q,sigma,B,R):
...
prc_mc = down_in_put_barrier_mc(S0,K,T,r,q,sigma,B,R)
print('\nThe Monte Carlo price of the down and in put option is:',round(prc_mc,4))
