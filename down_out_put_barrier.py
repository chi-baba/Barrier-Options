...
def down_out_put_barrier(S0,K,T,r,q,sigma,B,R):
    phi, eta = -1, 1
...
prc = down_out_put_barrier(S0,K,T,r,q,sigma,B,R)
print('\nThe price of the down and out put option is:',round(prc,4))


# Monte Carlo Simulation
def down_out_put_barrier_mc(S0,K,T,r,q,sigma,B,R):
...
prc_mc = down_out_put_barrier_mc(S0,K,T,r,q,sigma,B,R)
print('\nThe Monte Carlo price of the down and out put option is:',round(prc_mc,4))
