...
def up_in_call_barrier_mc(S0,K,T,r,q,sigma,B,R):
    # up and in call
...
prc_mc = up_in_call_barrier_mc(S0,K,T,r,q,sigma,B,R)
print('\nThe Monte Carlo price of the up and in call option is:',round(prc_mc,4))
