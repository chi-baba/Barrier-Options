...
def down_in_call_barrier(S0,K,T,r,q,sigma,B,R):
    phi, eta = 1, 1
...
prc = down_in_call_barrier(S0,K,T,r,q,sigma,B,R)
print('\nThe price of the down and in call option is:',round(prc,4))

# Monte Carlo Simulation
def down_in_call_barrier_mc(S0,K,T,r,q,sigma,B,R):
    # up and in call
...
prc_mc = down_in_call_barrier_mc(S0,K,T,r,q,sigma,B,R)
print('\nThe Monte Carlo price of the down and in call option is:',round(prc_mc,4))
